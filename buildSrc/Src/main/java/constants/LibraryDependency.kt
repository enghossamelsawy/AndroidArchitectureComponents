object LibraryDependency {
    ...
    const val SWIPE_TO_REFERESH =
        "androidx.swiperefreshlayout:swiperefreshlayout:${Version.SWIPE_TO_REFERESH}"
    ...
    const val RETROFIT_INTERCEPTOR =
        "com.squareup.okhttp3:logging-interceptor:${Version.RETROFIT_CONVERTER}"
